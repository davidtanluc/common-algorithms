...
/// u,v,k
val Vertices = 6 // nos of vertex, nos of nodes
...
def solution(start: Int, end: Int, graph: Array[Array[Int]]): Unit = {
  ...
  for (i <- 0 until Vertices) {
    ...
    //println(i, "i shortestpath : ", shortestpath)
    /*
(0,i shortestpath : ,2147483647)
(1,i shortestpath : ,2147483647)
(2,i shortestpath : ,5)
(3,i shortestpath : ,10)
(4,i shortestpath : ,2147483647)
(5,i shortestpath : ,12)
     */
